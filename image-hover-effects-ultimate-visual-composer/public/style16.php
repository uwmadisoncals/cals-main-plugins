...
function oxilab_flip_box_shortcode_function_style16($styleid, $userdata, $styledata, $listdata) {
     ?>
...
background-size: 100% 100%;
        ...
        ?>
                    ...
                    .oxilab-flip-box-body-<?php echo $styleid; ?>-<?php echo $value['id']; ?> .oxilab-flip-box-<?php echo $styleid; ?>-data .oxilab-icon-data{
