...
function oxilab_flip_box_shortcode_function_style11($styleid, $userdata, $styledata, $listdata) {
    ?>
                                    ...
                                    <div class="oxilab-flip-box-back">
                                        <div class="oxilab-flip-box-back-<?php echo $styleid; ?>">
                                            <div class="oxilab-flip-box-back-<?php echo $styleid; ?>-data">
                                                ...
                                                <div class="oxilab-icon">
                                                    <div class="oxilab-icon-data">
                                                        <?php echo oxilab_flip_box_font_icon($filesdata[11]) ?>
                                                    </div>
                                                </div>
                                                <div class="oxilab-info">
                                                    <?php echo oxilab_flip_box_special_charecter($filesdata[9]); ?>
                                                </div>
                                                <?php
                                                if ($filesdata[13] != '') {
                                                    echo '<a href="' . $filesdata[15] . '" target="' . $styledata[53] . '">';
...
background-size: 100% 100%;
    ...
    <style>
        ...
        .oxilab-flip-box-back-<?php echo $styleid; ?>-data .oxilab-heading{
            ...
            font-family: <?php echo oxilab_flip_box_font_familly_charecter($styledata[139]); ?>;
        ...
        .oxilab-flip-box-back-<?php echo $styleid; ?>-data .oxilab-button-data{
            ...
            font-family: <?php echo oxilab_flip_box_font_familly_charecter($styledata[157]); ?>;
