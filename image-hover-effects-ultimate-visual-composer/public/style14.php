...
function oxilab_flip_box_shortcode_function_style14($styleid, $userdata, $styledata, $listdata) {
    ?>
                                    ...
                                    <div class="oxilab-flip-box-back">
                                        <div class="oxilab-flip-box-back-<?php echo $styleid; ?>">
                                            <div class="oxilab-flip-box-back-<?php echo $styleid; ?>-data2">
                                                <div class="oxilab-icon">
                                                    <div class="oxilab-icon-data">
                                                       <?php echo oxilab_flip_box_font_icon($filesdata[19]) ?>
                                                    </div>
                                                </div>
                                            </div>
...
background-size: 100% 100%;
    ...
    <style>
        ...
        .oxilab-flip-box-back-<?php echo $styleid; ?>-data .oxilab-heading{
            ...
            font-family: <?php echo oxilab_flip_box_font_familly_charecter($styledata[159]); ?>;
        ...
        .oxilab-flip-box-back-<?php echo $styleid; ?>-data .oxilab-button-data{
            ...
            font-family: <?php echo oxilab_flip_box_font_familly_charecter($styledata[213]); ?>;
