...
$editdata = array('', 'Give Your Font Title', '', 'fab fa-facebook', '', '', '', 'Add backend Info text unless make it blank.', '', '', '', '', '', 'Add font info text unless make it blank.',);
$itemid = '';
$value = '';
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-half">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_number('front-icon-width', $styledata[75], '1', 'Icon width', 'Set your Icon Width and Height Size.');
                                                ...
                                                echo oxilab_flip_box_admin_text_align('front-icon-text-align', $styledata[81], 'Text Align', 'Give your Icon Text Align');
                                                ?> 
                                            </div>
                                        </div>
                                        <div class="oxilab-tabs-content-div-half">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxilab_flip_box_admin_number('front-info-size', $styledata[101], '1', 'Font Size', 'Set your front Info Font Size');
                                                ...
                                                echo oxilab_flip_box_admin_font_family('front-info-family', $styledata[103], 'Font Family', 'Give your Prepared Font from our Google Font List');
                                                echo oxilab_flip_box_admin_font_style('front-info-style', $styledata[105], 'Font Style', 'Set your Info Font Style');
                                                echo oxilab_flip_box_admin_font_weight('front-info-weight', $styledata[107], 'Font Weight', 'Give your Front Info Font Weight');
                                                echo oxilab_flip_box_admin_text_align('front-info-text-align', $styledata[109], 'Text Align', 'Give your Info Text Align');
                                                echo oxilab_flip_box_admin_number_double('front-info-padding-top', $styledata[111], 'front-info-padding-bottom', $styledata[113], 'Padding Top Bottom', 'Set Your Info  Padding Top and Bottom');
                                                echo oxilab_flip_box_admin_number_double('front-info-padding-left', $styledata[115], 'front-info-padding-right', $styledata[117], 'Padding Left Right', 'Set Your Info  Padding Left and Right');
                                                ?> 
                                            </div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo $styledata[143]; ?></textarea>
                    ...
                    <form method="POST">
                        <div class="modal-content">                            
                            ...
                            <div class="modal-body">
                                ...
                                echo oxilab_flip_box_admin_input_text_area('flip-box-font-desc', $editdata[13], 'Font Info:', 'Add font Info text unless make it blank.');
