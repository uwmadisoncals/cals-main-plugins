...
$editdata = array('', 'Give Your Title', '', 'fab fa-facebook', '', '', '', 'Add backend Info text unless make it blank.', '', '', '', '', '', '', '', '', '',);
$itemid = '';
$value = '';
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                ?>  
                                                <?php
                                                echo oxilab_flip_box_admin_color('front-background-color', $styledata[5], 'rgba', 'Background Color', 'Set your Front Background Color', 'background', '.oxilab-flip-box-'.$styleid.'-data');
                                                echo oxilab_flip_box_admin_number('front-image-height', $styledata[69], '1', 'Image Height', 'Set your Front Image Height, Based on Percentize with Image Width');
                                                ...
                                                echo oxilab_flip_box_admin_color('front-border-color', $styledata[7], '', 'Border Color', 'Set your Border Color', 'background-color', '.oxilab-flip-box-'.$styleid.'');
                                                echo oxilab_flip_box_admin_number('front-border-size', $styledata[75], '1', 'Border Size', 'Give your Border Size around the Flip');
                                                ?>    
                                            </div> 
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                echo oxilab_flip_box_admin_color('front-icon-color', $styledata[9], '', 'Icon Color', 'Set your Icon Color', 'color', '.oxilab-flip-box-'.$styleid.'-image-icon [class^=\'fa\']');
                                                echo oxilab_flip_box_admin_color('front-icon-background', $styledata[11], 'rgba', 'Icon Background', 'Set your icon Background Color','background', '.oxilab-flip-box-'.$styleid.'-image-icon');
                                        ...
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_color('front-heading-color', $styledata[13], '', 'Title Color', 'Set your Front Title Color', 'color', '.oxilab-flip-box-'.$styleid.'-heading-data');
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-3">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxilab_flip_box_admin_color('backend-background-color', $styledata[15], 'rgba', 'Background Color', 'Set your Backend Background Color', 'border-color', '.oxilab-flip-box-back-'.$styleid.'');
                                                ...
                                                echo oxilab_flip_box_admin_number('backend-border-size', $styledata[105], '1', 'Border Size', 'Give your Border Size around the Flip');
                                                echo oxilab_flip_box_admin_color('backend-border-color', $styledata[17], '', 'Border Color', 'Set your Border Color', 'background-color', '.oxilab-flip-box-back-'.$styleid.'');
                                                ?>    
                                            </div> 
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                        ...
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_number_double('backend-button-padding-top', $styledata[133], 'backend-button-padding-left', $styledata[135], 'Padding', 'Set Your Backend Button Padding Top Bottom and left Right');
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo $styledata[149]; ?></textarea>
                    ...
                    <form method="POST">
                        <div class="modal-content">                            
                            ...
                            <div class="modal-body">
                                ...
                                echo oxilab_flip_box_admin_input_text('flip-box-front-icons', $editdata[3], 'Front Icon', 'Add your front icon, Use Font-Awesome class name. As example fab fa-facebook-f');
                                ?>
                                <div class="form-group">
