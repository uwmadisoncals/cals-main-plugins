...
$editdata = array('', 'Give Your Font Title', '', 'fab fa-facebook', '', '', '', 'Add backend Info text unless make it blank.', '', '', '', '', '', '', '', '', '', 'Give Your Backend Title',);
$itemid = '';
$value = '';
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_color('front-top-border-color', $styledata[11], '', 'Top Border Color', 'Set your Front Top Border Color', 'background-color', '.oxilab-flip-box-' . $styleid . ' .oxilab-span');
                                                echo oxilab_flip_box_admin_number('front-top-border-height', $styledata[75], '1', 'Top Border Height', 'Set your Top Border Height.');
                                                ?>    
                                            </div> 
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo $styledata[163]; ?></textarea>
