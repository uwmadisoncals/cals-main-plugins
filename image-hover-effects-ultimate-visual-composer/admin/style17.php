...
$editdata = array('', 'Give Your Font Title', '', 'fab fa-facebook', '', '', '', 'Add backend Info text unless make it blank.', '', '', '', '', '', '',);
$itemid = '';
$value = '';
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-5">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_number('flip-border-radius', $styledata[141], '1', 'Border Radius', 'Set your flip Border Radius');
                                                ?>    
                                            </div> 
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">                                         
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_number_double('front-padding-top', $styledata[69], 'front-padding-left', $styledata[71], 'Padding', 'Set your Front Padding as Top Bottom and Left Right');
                                                echo oxilab_flip_box_admin_border('flip-col-border-size', $styledata[101], 'flip-col-border-style', $styledata[103], 'Border Size', 'Set your front border size with different style');
                                                echo oxilab_flip_box_admin_color('front-border-color', $styledata[21], '', 'Border Color', 'Set your Border Color', 'border-color', '.oxilab-flip-box-' . $styleid . '');
                                                ?>    
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                <?php
                                                echo oxilab_flip_box_admin_number('front-icon-size', $styledata[73], '1', 'Icon Size', 'Set your Icon Font Size');
                                                echo oxilab_flip_box_admin_color('front-icon-color', $styledata[7], '', 'Icon Color', 'Set your Icon Color', 'color', '.oxilab-flip-box-' . $styleid . '-data .oxilab-icon-data [class^=\'fa\']');
                                                echo oxilab_flip_box_admin_number_double('front-icon-padding-top-bottom', $styledata[77], 'front-icon-padding-left-right', $styledata[79], 'Icon Padding', 'Set your Icon Padding as Top Bottom and Left Right');
                                                ?> 
                                            </div>
                                        </div>
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_color('front-heading-color', $styledata[11], '', 'Title Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $styleid . '-data .oxilab-heading');
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-3">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxilab_flip_box_admin_color('backend-background-color', $styledata[13], 'rgba', 'Background Color', 'Set your Backend Background Color', 'background-color', '.oxilab-flip-box-back-' . $styleid . '');
                                                echo oxilab_flip_box_admin_number_double('backend-padding-top', $styledata[119], 'backend-padding-left', $styledata[121], 'Padding', 'Set your Backend Padding as Top Bottom and Left Right');
                                                echo oxilab_flip_box_admin_border('flip-backend-border-size', $styledata[105], 'flip-backend-border-style', $styledata[107], 'Border Size', 'Set your backend border size with different style');
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxilab_flip_box_admin_number('backend-info-size', $styledata[123], '1', 'Font Size', 'Set your Backend Info Font Size');
                                                echo oxilab_flip_box_admin_color('backend-info-color', $styledata[15], '', 'Text Color', 'Set your Backend Info Color', 'color', '.oxilab-flip-box-back-' . $styleid . '-data .oxilab-info');
                                                echo oxilab_flip_box_admin_font_family('backend-info-family', $styledata[125], 'Font Family', 'Give your Prepared Font from our Google Font List');
                                                echo oxilab_flip_box_admin_font_style('backend-info-style', $styledata[127], 'Font Style', 'Set your Backend Info Font Style');
                                                echo oxilab_flip_box_admin_font_weight('backend-info-weight', $styledata[129], 'Font Weight', 'Give your Backend Info Font Weight');
                                                echo oxilab_flip_box_admin_text_align('backend-info-text-align', $styledata[131], 'Text Align', 'Give your Backend Info Text Align');
                                                echo oxilab_flip_box_admin_number_double('backend-info-padding-top', $styledata[133], 'backend-info-padding-bottom', $styledata[135], 'Padding Top Bottom', 'Set Your Backend Info  Padding Top and Bottom');
                                                echo oxilab_flip_box_admin_number_double('backend-info-padding-left', $styledata[137], 'backend-info-padding-right', $styledata[139], 'Padding Left Right', 'Set Your Backend Info  Padding Left and Right');
                                                ?> 
                                            </div> 
                                        </div>
                                        ...
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxilab_flip_box_admin_number('backend-button-size', $styledata[143], '1', 'Font Size', 'Set your Backend Button Font Size');
                                                echo oxilab_flip_box_admin_color('backend-button-color', $styledata[17], '', 'Button Color', 'Set your Backend Button Color', 'color', '.oxilab-flip-box-back-' . $styleid . '-data .oxilab-button-data');
                                                echo oxilab_flip_box_admin_color('backend-button-hover-color', $styledata[19], '', 'Button Hover', 'Set your Backend Button Hover Color', 'color', '.oxilab-flip-box-back-' . $styleid . '-data .oxilab-button-data:hover');
                                                echo oxilab_flip_box_admin_font_family('backend-button-family', $styledata[145], 'Font Family', 'Give your Prepared Font from our Google Font List');
                                                echo oxilab_flip_box_admin_font_style('backend-button-style', $styledata[147], 'Font Style', 'Set your Backend Button Font Style');
                                                echo oxilab_flip_box_admin_font_weight('backend-button-weight', $styledata[149], 'Font Weight', 'Give your Backend Button Font Weight');
                                                echo oxilab_flip_box_admin_number_double('backend-button-info-padding-top', $styledata[151], 'backend-button-info-padding-left', $styledata[153], 'Padding', 'Set Your Backend Button Padding Top Bottom and left Right');
                                                echo oxilab_flip_box_admin_number('backend-button-border-radius', $styledata[155], '1', 'Border Radius', 'Set your Backend Button Border Radius');
                                                echo oxilab_flip_box_admin_text_align('backend-button-text-align', $styledata[157], 'Text Align', 'Give your Backend Button Text Align');
                                                echo oxilab_flip_box_admin_number_double('backend-info-margin-top', $styledata[159], 'backend-info-margin-bottom', $styledata[161], 'Margin Top Bottom', 'Set Your Backend Info Margin Top and Bottom');
                                                echo oxilab_flip_box_admin_number_double('backend-info-margin-left', $styledata[163], 'backend-info-margin-right', $styledata[165], 'Margin Left Right', 'Set Your Backend Info Margin Left and Right');
                                                ?> 
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo $styledata[167]; ?></textarea>
                    ...
                    <form method="POST">
                        <div class="modal-content">                            
                            ...
                            <div class="modal-body">
                                ...
                                echo oxilab_flip_box_admin_input_text('flip-box-backend-button-text', $editdata[13], 'Backend Button Text', 'Add your backend button text.');
                                echo oxilab_flip_box_admin_input_text('flip-box-backend-link', $editdata[9], 'Link', 'Add your desire link or url unless make it blank');
                                ?>  
                                <div class="form-group">
                                    <label for="flip-box-image-upload-url-02"> Backend Background Image</label>
                                    <div class="col-xs-12-div">
                                        <div class="col-md-8 col-xs-6" style="padding-left: 0px;">
                                            <input type="text "class="form-control" name="flip-box-image-upload-url-02" id="flip-box-image-upload-url-02"  value="<?php echo $editdata[11]; ?>">
                                        </div>
                                        <div class="col-md-4 col-xs-6">
