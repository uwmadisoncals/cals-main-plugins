...
$editdata = array('', 'Give Your Font Title', '', '', '', '', '', 'Add backend Info text unless make it blank.', '', '', '', '', '', '', '', '', '', 'Give Your Backend Title',);
$itemid = '';
$value = '';
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_number_double('front-image-margin-top', $styledata[71], 'front-image-margin-bottom', $styledata[73], 'Image Margin Top Bottom', 'Set Your Image Margin Top and Bottom(If Needed)');
                                                echo oxilab_flip_box_admin_number_double('front-image-margin-left', $styledata[75], 'front-image-margin-right', $styledata[77], 'Image Margin Left Right', 'Set Your Image Margin Left and Right(If Needed)');
                                                ...
                                                echo oxilab_flip_box_admin_border('flip-col-border-size', $styledata[163], 'flip-col-border-style', $styledata[165], 'Border Size', 'Set your front border size with different style');
                                                ?>    
                                            </div>                                             
                                        </div>
                                        <div class="oxilab-tabs-content-div-half">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-3">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_color('backend-border-color', $styledata[9], '', 'Border Color', 'Set your Border Color', 'border-color', '.oxilab-flip-box-back-' . $styleid . '');
                                                echo oxilab_flip_box_admin_border('flip-backend-border-size', $styledata[167], 'flip-backend-border-style', $styledata[169], 'Border Size', 'Set your backend border size with different style');
                                                ?>    
                                            </div> 
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
