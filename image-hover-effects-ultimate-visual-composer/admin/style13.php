                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-half">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_color('front-icon-background-color', $styledata[11], '', 'Icon Background Color', 'Set your Icon Background Color', 'background-color', '.oxilab-flip-box-' . $styleid . '-data .oxilab-icon-data [class^=\'fa\']');
                                                echo oxilab_flip_box_admin_color('front-icon-border-color', $styledata[7], '', 'Border Color', 'Set your Icon Border Color', 'border-color', '.oxilab-flip-box-' . $styleid . '-data .oxilab-icon-data');
                                        ...
                                        <div class="oxilab-tabs-content-div-half">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_color('front-info-color', $styledata[29], '', 'Text Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $styleid . '-data .oxilab-info');
