...
wp_add_inline_script('oxilab-bootstrap-js', 'jQuery(".oxi-btn").click(function(){
    ...
    <div class="oxilab-admin-wrapper">
        <div class="oxi-addons-promote-header">
            <div class="oxi-addons-promote-header-image">
                <img src="<?php echo plugins_url(); ?>/image-hover-effects-ultimate-visual-composer/admin/shortcode-addons.png">
            </div>
            ...
            <div class="oxilab-admin-wrapper">
                <div class="oxilab-admin-coupon">
                    ...
                    if ($status == 'valid') {
                        ...
                        echo 'Exclusive offer: Flipbox - Awesomes Flip Boxes Image Overlay are completely free with Shortcode Addons';
                    }
                    ?>
                </div>
            </div>
