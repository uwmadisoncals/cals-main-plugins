...
$editdata = array('', 'Give Your Font Title', '', 'fab fa-facebook', '', '', '', 'Give Your Backend Title', '', 'Add backend Info text unless make it blank.', '', 'fab fa-facebook', '', '', '', '', '', '',);
$itemid = '';
$value = '';
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-half">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_color('front-icon-background-color', $styledata[9], 'rgba', 'Icon Background Color', 'Set your Icon Background Color', 'background-color', '.oxilab-flip-box-' . $styleid . '-data .oxilab-icon-data');
                                                ...
                                                echo oxilab_flip_box_admin_number_double('front-icon-padding-top-bottom', $styledata[133], 'front-icon-padding-left-right', $styledata[135], 'Icon Padding', 'Set your Icon Padding as Top Bottom and Left Right');
                                                ?> 
                                            </div>
                                        </div>
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_color('front-heading-color', $styledata[11], '', 'Heading Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $styleid . '-data .oxilab-heading');
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-3">
                                        <div class="oxilab-tabs-content-div-half">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxilab_flip_box_admin_number('backend-icon-size', $styledata[77], '1', 'Icon Size', 'Set your Icon Font Size');
                                                echo oxilab_flip_box_admin_color('backend-icon-color', $styledata[17], '', 'Icon Color', 'Set your Icon Color', 'color', '.oxilab-flip-box-back-' . $styleid . '-data .oxilab-icon-data [class^=\'fa\']');
                                                echo oxilab_flip_box_admin_number('backend-icon-width', $styledata[79], '1', 'Icon width', 'Set your Icon Width and Height Size.');
                                                echo oxilab_flip_box_admin_number('backend-icon-border-bottom', $styledata[105], '1', 'Icon Border Bottom', 'Set your Icon Border Bottom Size.');
                                                echo oxilab_flip_box_admin_number_double('backend-icon-padding-top-bottom', $styledata[129], 'backend-icon-padding-left-right', $styledata[131], 'Icon Padding', 'Set your Icon Padding as Top Bottom and Left Right');
                                                ?> 
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                <?php
                                                echo oxilab_flip_box_admin_number('backend-heading-size', $styledata[137], '1', 'Font Size', 'Set your backend Heading Font Size');
                                                echo oxilab_flip_box_admin_color('backend-title-color', $styledata[15], '', ' Title Color', 'Set your Backend title Color', 'color', '.oxilab-flip-box-back-' . $styleid . '-data .oxilab-heading');
                                                echo oxilab_flip_box_admin_font_family('backend-heading-family', $styledata[139], 'Font Family', 'Give your Prepared Font from our Google Font List');
                                                echo oxilab_flip_box_admin_font_style('backend-heading-style', $styledata[141], 'Font Style', 'Set your Heading Font Style');
                                                echo oxilab_flip_box_admin_font_weight('backend-heading-weight', $styledata[143], 'Font Weight', 'Give your backend Heading Font Weight');
                                                echo oxilab_flip_box_admin_text_align('backend-heading-text-align', $styledata[145], 'Text Align', 'Give your Heading Text Align');
                                                echo oxilab_flip_box_admin_number_double('backend-heading-padding-top', $styledata[147], 'backend-heading-padding-bottom', $styledata[149], 'Padding Top Bottom', 'Set Your backend Heading  Padding Top and Bottom');
                                                echo oxilab_flip_box_admin_number_double('backend-heading-padding-left', $styledata[151], 'backend-heading-padding-right', $styledata[153], 'Padding Left Right', 'Set Your backend Heading  Padding Left and Right');
                                                ?> 
                                            </div>
                                        </div>
                                        <div class="oxilab-tabs-content-div-half">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxilab_flip_box_admin_number('backend-button-size', $styledata[155], '1', 'Font Size', 'Set your Backend Button Font Size');
                                                ...
                                                echo oxilab_flip_box_admin_font_family('backend-button-family', $styledata[157], 'Font Family', 'Give your Prepared Font from our Google Font List');
                                                echo oxilab_flip_box_admin_font_style('backend-button-style', $styledata[159], 'Font Style', 'Set your Backend Button Font Style');
                                                echo oxilab_flip_box_admin_font_weight('backend-button-weight', $styledata[161], 'Font Weight', 'Give your Backend Button Font Weight');
                                                echo oxilab_flip_box_admin_number_double('backend-button-info-padding-top', $styledata[163], 'backend-button-info-padding-left', $styledata[165], 'Padding', 'Set Your Backend Button Padding Top Bottom and left Right');
                                                echo oxilab_flip_box_admin_number('backend-button-border-radius', $styledata[167], '1', 'Border Radius', 'Set your Backend Button Border Radius');
                                                echo oxilab_flip_box_admin_text_align('backend-button-text-align', $styledata[169], 'Text Align', 'Give your Backend Button Text Align');
                                                echo oxilab_flip_box_admin_number_double('backend-info-margin-top', $styledata[171], 'backend-info-margin-bottom', $styledata[173], 'Margin Top Bottom', 'Set Your Backend Info Margin Top and Bottom');
                                                echo oxilab_flip_box_admin_number_double('backend-info-margin-left', $styledata[175], 'backend-info-margin-right', $styledata[177], 'Margin Left Right', 'Set Your Backend Info Margin Left and Right');
                                                ?> 
                                            </div>  
                                        </div>
                                    </div>                                  
                ...
                <div class="modal-dialog modal-md">
                    <form method="POST">
                        <div class="modal-content">                            
                            ...
                            <div class="modal-body">
                                <?Php
                                echo oxilab_flip_box_admin_input_text('flip-box-backend-title', $editdata[7], 'Backend Title', 'Add your flip backend title.');
                                echo oxilab_flip_box_admin_input_text_area('flip-box-backend-desc', $editdata[9], 'Backend Info:', 'Add backend Info text unless make it blank.');
                                echo oxilab_flip_box_admin_input_text('flip-box-backend-icons', $editdata[11], 'Backend Icon', 'Add your front icon, Use Font-Awesome class name. As example fab fa-facebook');
                                ...
                                echo oxilab_flip_box_admin_input_text('flip-box-backend-link', $editdata[15], 'Link', 'Add your desire link or url unless make it blank');
                                ?>  
                                <div class="form-group">
                                    <label for="flip-box-image-upload-url-02"> Backend Background Image</label>
                                    <div class="col-xs-12-div">
                                        <div class="col-md-8 col-xs-6" style="padding-left: 0px;">
                                            <input type="text "class="form-control" name="flip-box-image-upload-url-02" id="flip-box-image-upload-url-02"  value="<?php echo $editdata[17]; ?>">
                                        </div>
                                        <div class="col-md-4 col-xs-6">
