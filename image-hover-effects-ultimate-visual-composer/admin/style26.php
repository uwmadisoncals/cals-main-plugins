...
$editdata = array('', 'Give Your Front Title', '', '', '', '', '', 'Add backend Info text unless make it blank.', '', '', '', '', '', '', '', '', '', 'Give Your Backend Title',);
$itemid = '';
$value = '';
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_number('front-border-margin-top', $styledata[69], '', 'Margin', 'Set your front border Margin.');
                                                echo oxilab_flip_box_admin_number_double('front-padding-top', $styledata[71], 'front-padding-left', $styledata[73], 'Inner Padding', 'Set your front Padding as Top Bottom and Left Right');
                                                echo oxilab_flip_box_admin_color('front-border-color', $styledata[9], '', 'Border Color', 'Set your Border Color', 'border-color', '.oxilab-flip-box-'.$styleid.'');
                                                echo oxilab_flip_box_admin_border('flip-front-border-size', $styledata[75], 'flip-front-border-style', $styledata[77], 'Border Size', 'Set your front border size with different style');
                                                ?>    
                                            </div> 
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                <?php
                                                echo oxilab_flip_box_admin_number('front-number-size', $styledata[79], '1', 'Number Size', 'Set your Number Font Size');
                                                echo oxilab_flip_box_admin_color('front-number-color', $styledata[11], '', 'Number Color', 'Set your Number Color', 'color', '.oxilab-flip-box-'.$styleid.'-data .oxilab-icon-data');
                                                echo oxilab_flip_box_admin_font_family('front-number-family', $styledata[81], 'Font Family', 'Give your Prepared Font from our Google Font List');
                                                echo oxilab_flip_box_admin_font_style('front-number-style', $styledata[83], 'Font Style', 'Set your Number Font Style');
                                                echo oxilab_flip_box_admin_font_weight('front-number-weight', $styledata[85], 'Font Weight', 'Give your Front Number Font Weight');
                                                echo oxilab_flip_box_admin_number_double('front-number-padding-top-bottom', $styledata[87], 'front-number-padding-left-right', $styledata[89], 'Number Padding', 'Set your Number Padding as Top Bottom and Left Right');
                                                ?> 
                                            </div>
                                        </div>
                                        <div class="oxilab-tabs-content-div-half">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-3">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxilab_flip_box_admin_color('backend-background-color', $styledata[15], 'rgba', 'Background Color', 'Set your Backend Background Color', 'background-color', '.oxilab-flip-box-body-'.$styleid.' .oxilab-flip-box-back');
                                                echo oxilab_flip_box_admin_number('backend-border-margin-top', $styledata[105], '', 'Margin', 'Set your backend border Margin.');
                                                ...
                                                echo oxilab_flip_box_admin_border('flip-backend-border-size', $styledata[149], 'flip-backend-border-style', $styledata[151], 'Border Size', 'Set your backend border size with different style');
                                                ?>    
                                            </div> 
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_color('backend-title-bottom-border-color', $styledata[7], '', 'Title Bottom Color', 'Set your Backend Title Bottom Border Color', '', '');
                                                ?>    
                                            </div> 
                                        </div>
                                        <div class="oxilab-tabs-content-div-half">
