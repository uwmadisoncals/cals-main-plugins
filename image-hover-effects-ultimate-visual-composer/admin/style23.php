...
if (!empty($_POST['submit']) && $_POST['submit'] == 'submit') {
    if (!wp_verify_nonce($nonce, 'oxilab_flip_box_new_data')) {
        ...
        if ($_POST['item-id'] == '') {
            $wpdb->query($wpdb->prepare("INSERT INTO {$table_list} (styleid, files, css) VALUES ( %d, %s)", array($styleid, $data)));
        }
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_number('front-margin-top-bottom', $styledata[105], '', 'Margin', 'Set your Front Margin as Top Bottom and Left Right');
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-3">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_number('backend-margin-top-bottom', $styledata[69], '', 'Margin', 'Set your Backend Margin as Top Bottom and Left Right');
                                        ...
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxilab_flip_box_admin_number('backend-title-border-width', $styledata[131], '1', 'Border Width', 'Set your Backend Title Bottom Border Width');
                                                echo oxilab_flip_box_admin_number('backend-title-border-height', $styledata[133], '1', 'Border Height', 'Set your Backend Title Bottom Border Height');
                                                echo oxilab_flip_box_admin_color('backend-title-bottom-border-color', $styledata[25], '', 'Title Bottom Color', 'Set your Backend Title Bottom Border Color', 'background-color', '.oxilab-flip-box-back-' . $styleid . '-data .oxilab-heading .oxilab-span');
                                                ?>    
                                            </div> 
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
