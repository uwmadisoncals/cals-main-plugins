                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_number('front-padding-top', $styledata[71], '', 'Inner Padding', 'Set your Front Padding.');
                                                echo oxilab_flip_box_admin_number('front-margin-top-bottom', $styledata[105], '', 'Image Padding', 'Set your Front Margin as Top Bottom and Left Right');
                                                ...
                                                echo oxilab_flip_box_admin_border('flip-col-border-size', $styledata[159], 'flip-col-border-style', $styledata[161], 'Border Size', 'Set your front border size with different style');
                                                ?>    
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-3">
                                        <div class="oxilab-tabs-content-div-half">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxilab_flip_box_admin_number('backend-border-padding-top', $styledata[163], '', 'Padding', 'Set your backend border Padding.');
                                                ...
                                                echo oxilab_flip_box_admin_border('flip-backend-border-size', $styledata[151], 'flip-backend-border-style', $styledata[149], 'Border Size', 'Set your backend border size with different style');
                                                ?>    
                                            </div> 
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
