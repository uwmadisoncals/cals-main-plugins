...
<div id="twenty20_select" style="display:none;">
  <div class="wrap">
    <h1>Insert Twenty20 Shortcode</h1>
...
<div id="twenty20-help" style="display:none;">
  <style type="text/css" media="screen">
    .t20-table{border: 1px solid #eee; margin-top: 20px;}
  ...
  <div class="wrap">
    ...
    <h4>Quick Example</h4>
    <code class="example">[twenty20 img1="" img2="" direction="vertical" offset="0.5" align="right" width="60%"]</code>
