...
class twenty20_slider_widget extends WP_Widget {
  ...
  public function widget( $args, $instance ) {
    ...
    <div class="mac-wrap">
      ...
      <div class="twenty20">
        <div class="twentytwenty-container"<?php echo $isVertical; ?>>
        ...
        <script>
          jQuery(window).load(function(){
            <?php if($instance['is_vertical'] == true) { ?>
              jQuery(".twentytwenty-container[data-orientation=\'vertical\']").twentytwenty({default_offset_pct: <?php echo $instance['t20_widget_offset']; ?>, orientation: 'vertical'});
            <?php }else{ ?>
            jQuery(".twentytwenty-container[data-orientation!=\'vertical\']").twentytwenty({default_offset_pct: <?php echo $instance['t20_widget_offset']; ?>});
            <?php } ?>
          });
        </script>
      </div>
