                                ...
                                foreach ($terminals as $terminal) {
                                    ...
                                    if ($stats_code == 200) {
                                        ...
                                        <li>
                                            ...
                                            ?><img src="<?php print plugins_url('../images/error.png', __FILE__); ?>" align="middle" alt="<?php print $error_msg; ?>" title="<?php print $error_msg; ?>"> The Varnish control terminal is not responding at <?php print $varnish_control_terminal; ?><?php }
                                        ?>
                                    </li>
                                <?php } ?>
                            </ul>
