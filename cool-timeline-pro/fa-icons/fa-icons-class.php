    ...
    class Ctl_Fa_Icons {
      ...
      public function clt_front_scripts() {
        if ( apply_filters( 'fa_field_load_styles', true ) ) {
          wp_enqueue_style( 'font-awesome', CTP_FA_URL . 'css/font-awesome/css/font-awesome.min.css' );
        }
      }
      ...
      public function ctl_ss() {
        ...
        if ( in_array( get_current_screen()->post_type, $this->screens ) ) {
          ...
          wp_enqueue_style( 'fa-field-fontawesome-css', CTP_FA_URL . 'css/font-awesome/css/font-awesome.min.css' );
          // load up plugin css
          wp_enqueue_style( 'fa-field-css', CTP_FA_URL . 'css/fa-field.css' );
          // load up plugin js
          wp_enqueue_script( 'fa-field-js', CTP_FA_URL . 'js/fa-field.js', array( 'jquery' ) );
        }
      }
      /**
      ...
      if ( ! $icons ) {
          ...
          $subject = file_get_contents( CTP_FA_DIR . 'css/font-awesome/css/font-awesome.css' );
