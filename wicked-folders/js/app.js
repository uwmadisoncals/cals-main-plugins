;(function( window, $, undefined ){
    ...
    wickedfolders.views.FolderBrowser = wickedfolders.views.View.extend({
        ...
        cloneFolder: function( e ){
            ...
            var folder = new wickedfolders.models.Folder( this.folder().toJSON() ),
                view = this;
    ...
    wickedfolders.views.FolderDetails = wickedfolders.views.View.extend({
            ...
            if ( 'delete' == this.options.mode ) {
                ...
                this.model.destroy( {
                    ...
                    success: function( model, response, options ){
                        ...
                        view.options.pane.model.set( 'folder', parent );
                        view.setBusy( false );
                        view.$el.hide();
                    }
                } );
        ...
        cloneFolder: function( e ){
            ...
            var folder = new wickedfolders.models.Folder( this.model.toJSON() ),
                view = this;
    ...
    wickedfolders.views.ObjectFolderPane = wickedfolders.views.View.extend({
                ...
                helper: function( e ){
                    ...
                    if ( checkbox.prop( 'checked' ) || 'on' == checkbox.val() || ! checkbox.val() ) {
                        ...
                        if ( isMedia ) {
                            ...
                            var title = $( row ).find( '.row-title' ).text().trim();
                        }
                    ...
                    view.model.set( 'postsToMove', posts );
            ...
            this.$( '.wicked-tree [data-folder-id="0"] .wicked-folder' ).droppable( {
                ...
                drop: function( e, ui ) {
                    ...
                    if ( ui.draggable.hasClass( 'wicked-move-multiple' ) ) {
                        ...
                        view.removePostRows( objectIds );
                        view.model.get( 'postsToMove' ).reset();
        ...
        clickFolder: function( e ) {
            var currentFolderId = this.folder(),
                id = $( e.currentTarget ).parent().attr( 'data-folder-id' );

            this.model.set( 'folder', id, {silent: true} );

            this.$( '.wicked-tree [data-folder-id="' + id + '"]' ).removeClass( 'wicked-selected' );
            this.$( '.wicked-tree [data-folder-id="' + currentFolderId + '"]' ).addClass( 'wicked-selected' );
