	...
	function get_settings() {
		...
		return array(
			...
			array(
				...
				'desc'    => '<em>' . sprintf(
					__( 'Please note that if you have large number of plugins or themes, you may need to <a href="%s" target="_blank">increase your WP memory limits</a> to use "Download all" tools. Your current memory limits are: %s (standard) and %s (admin).', 'download-plugins-dashboard' ),
						'https://codex.wordpress.org/Editing_wp-config.php#Increasing_memory_allocated_to_PHP', WP_MEMORY_LIMIT, WP_MAX_MEMORY_LIMIT ) . '</em>',
			),
			array(
			...
			array(
				...
				'type'    => 'title',
				'desc'    => apply_filters( 'alg_download_plugins', '<em>' . sprintf( __( 'Periodical downloads are available in %s only.', 'download-plugins-dashboard' ),
					'<a target="_blank" href="https://wpfactory.com/item/download-plugins-and-themes-from-dashboard/">' .
						__( 'Pro version', 'download-plugins-dashboard' ) . '</a>' ) . '</em>', 'settings' ),
			),
			array(
				...
				'desc'    => apply_filters( 'alg_download_plugins', '<em>' . sprintf( __( 'Possible options: %s.', 'download-plugins-dashboard' ),
					implode( '; ', $period_options ) ) . '</em>', 'settings_plugins_bulk_period' ),
				'custom_attributes' => apply_filters( 'alg_download_plugins', 'disabled', 'settings' ),
			),
			array(
				...
				'default' => '',
				'options' => $period_options,
				'desc'    => apply_filters( 'alg_download_plugins', '', 'settings_themes_bulk_period' ),
				'custom_attributes' => apply_filters( 'alg_download_plugins', 'disabled', 'settings' ),
			),
			array(
