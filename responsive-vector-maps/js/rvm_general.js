(function($) {
	$(function() {	
		...
		/****************  Start: Show / hide custom image MODULE uploader *****************/

		$( '.rvm_mbe_marker_icon_choice' ).change( function() {

			console.log($( 'input[name=rvm_mbe_marker_icon_choice]:checked' ).val());
			if( $( 'input[name=rvm_mbe_marker_icon_choice]:checked' ).val() == 'rvm_custom_marker_icon') {
				$( '#rvm_custom_marker_icons' ).show();
				$( '#rvm_default_marker_icons' ).hide();
			}

			else {
				$( '#rvm_custom_marker_icons' ).hide();
				$( '#rvm_default_marker_icons' ).show();	}

		});
		
		/****************  End: Show / hide custom image MODULE uploader *****************/

		/****************  Start: Add markers' custom image MODULE uploader *****************/

		
		/****************  End: Add markers' custom image MODULE uploader *****************/
        ...
        var file_frame;
          ...
          $("#rvm_custom_map_uploader_button,#rvm_custom_marker_icon_module_uploader_button").live('click', function( event ){
            ...
            file_frame.on( 'select', function() {
              ...
              // Do something with attachment.id and/or attachment.url here
               jQuery("#rvm_custom_map_filename,#rvm_mbe_custom_marker_icon_module").val( attachment.url );
            });
