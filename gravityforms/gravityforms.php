...
SET d.value = l.value"
	...
	public static function admin_bar() {
		...
		if ( GFCommon::current_user_can_any( 'gravityforms_edit_forms' ) ) {
			$img = self::get_admin_icon_svg();
			$args = array(
				'id'    => 'gform-forms',
				'title' => '<span class="ab-icon gforms-menu-icon">' . $img . '</span><span class="ab-label">'. esc_html__( 'Forms', 'gravityforms' ) . '</span></a>',
	...
	public static function action_admin_head() {
		...
		<style>
			...
			#wp-admin-bar-gform-forms.hover svg path{
				fill:#00b9eb;
			}
			@media screen and ( max-width: 782px ) {
				#wpadminbar #wp-admin-bar-gform-forms .ab-icon {
				...
				#wpadminbar #wp-admin-bar-gform-forms .ab-icon svg{
					line-height: 53px;
