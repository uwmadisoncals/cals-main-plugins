...
<form class="jck-sfr-form jck-sfr-form--submission" action="" method="post">
	<label for="jck-sfr-input-title" class="jck-sfr-form__row">
		...
		<div class="jck-sfr-search-field">
			<input id="jck-sfr-input-title" name="jck-sfr-submission-title" class="jck-sfr-form__title" type="text" placeholder="<?php esc_attr_e( 'Enter your request...', 'simple-feature-requests' ); ?>" value="<?php echo esc_attr( $title ); ?>">
			<i class="jck-sfr-search-field__icon jck-sfr-search-field__icon--loader"></i>
			<i class="jck-sfr-search-field__icon jck-sfr-search-field__icon--clear jck-sfr-js-clear-search-field" <?php if ( $search ) { echo 'style="display: block;"'; } ?>></i>
		</div>
	</label>
	<div class="jck-sfr-form__reveal" <?php if ( $search && $wp_query->found_posts <= 0 ) { echo 'style="display: block;"'; } ?>>
		<label for="jck-sfr-input-description" class="jck-sfr-form__row">
			<strong><?php _e( 'Description', 'simple-feature-requests' ); ?></strong>
			<textarea id="jck-sfr-input-description" name="jck-sfr-submission-description"><?php echo $description; ?></textarea>
		</label>
	...
	<div class="jck-sfr-form__choices" <?php if ( ! $search || $wp_query->found_posts <= 0 ) {
		echo 'style="display: none;"';
	} ?>>
		<span class="jck-sfr-form__choices-vote"><?php printf( __( 'Vote for an existing request (%s)', 'simple-feature-requests' ), sprintf( '<span class="jck-sfr-form__choices-count">%s</span>', $wp_query->found_posts ) ); ?></span>
