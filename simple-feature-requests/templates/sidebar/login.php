...
<div class="jck-sfr-sidebar-widget jck-sfr-sidebar-widget--login">
	...
	<?php } else { ?>
		...
		<p class="jck-sfr-profile">
			...
			<strong class="jck-sfr-profile__username"><?php printf( __( 'Hey, %s.', 'simple-feature-requests' ), JCK_SFR_User::get_username() ); ?></strong> <br>
			<a class="jck-sfr-profile__logout" href="<?php echo wp_logout_url( get_post_type_archive_link( 'cpt_feature_requests' ) ); ?>"><?php _e( 'Logout', 'simple-feature-requests' ); ?></a>
		</p>
	<?php } ?>
</div>