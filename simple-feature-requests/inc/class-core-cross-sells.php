...
class JCK_SFR_Core_Cross_Sells {
	...
	public static function get_output() {
		...
		$utm = '?utm_source=simple-feature-requests&utm_medium=dashboard&utm_campaign=cross-sell';
		...
		<div class="iconic-cross-sells-wrapper">
			<div class="iconic-cross-sells-columns iconic-cross-sells-columns--plugins">
				<div class="iconic-cross-sells">
					<?php foreach ( self::$selected_plugins as $cross_sell ) { ?>
						<div class="iconic-cross-sell">
							<a class="iconic-cross-sell__image-link" href="<?php echo esc_attr( $cross_sell['url'] . $utm ); ?>" target="_blank">
								<img class="iconic-cross-sell__image" src="<?php echo $cross_sell['image_src']; ?>" alt="<?php echo esc_attr( $cross_sell['title'] ); ?>">
							</a>
							<div class="iconic-cross-sell__border">
								<h4 class="iconic-cross-sell__title">
									<a href="<?php echo esc_attr( $cross_sell['url'] . $utm ); ?>" target="_blank">
										<?php echo $cross_sell['title']; ?>
									</a>
								</h4>
								<p class="iconic-cross-sell__description"><?php echo $cross_sell['description']; ?></p>
								<div class="iconic-cross-sell__footer">
									<a class="iconic-cross-sell__link button-secondary" href="<?php echo esc_attr( $cross_sell['url'] . $utm ); ?>" target="_blank">
										<?php _e( 'Learn More', 'simple-feature-requests' ); ?>
				...
				<a href="https://iconicwp.com/products<?php echo esc_attr( $utm ); ?>" class="button-secondary"><?php _e( 'View All Iconic Plugins', 'simple-feature-requests' ); ?></a>
			</div>

			<div class="iconic-cross-sells-columns iconic-cross-sells-columns--testimonials">
				<p class="iconic-trust">
					<span class="dashicons dashicons-thumbs-up"></span> Trusted by over 10,000 WooCommerce Businesses and Online Shops
				</p>
				<?php foreach ( self::$selected_plugins as $cross_sell ) { ?>
					<?php if ( ! $cross_sell['testimonial'] ) {
						continue;
					} ?>
					...
					<div class="iconic-testimonial">
						...
						<h5 class="iconic-testimonial__title"><?php echo $cross_sell['testimonial']['title']; ?></h5>
						<p class="iconic-testimonial__text"><?php echo $cross_sell['testimonial']['text']; ?></p>
						<p class="iconic-testimonial__cite">
							<strong><?php echo $cross_sell['testimonial']['cite']; ?></strong> on
							<a href="<?php echo esc_attr( $cross_sell['url'] . $utm ); ?>" target="_blank"><?php echo $cross_sell['title']; ?></a>
						</p>
					</div>
				<?php } ?>
			</div>
