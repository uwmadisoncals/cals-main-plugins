...
use Exception;
use MailPoet\Dependencies\Monolog\Formatter\LineFormatter;
 ...
 *
 *      $logger = new \MailPoet\Dependencies\Monolog\Logger('all', array(new \MailPoet\Dependencies\Monolog\Handler\PHPConsoleHandler()));
 *      \MailPoet\Dependencies\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('MailPoet\Dependencies\Monolog\\'), // array Hide calls of classes started with...
    ...
    /**
     * @param  array          $options   See \MailPoet\Dependencies\Monolog\Handler\PHPConsoleHandler::$options for more details
