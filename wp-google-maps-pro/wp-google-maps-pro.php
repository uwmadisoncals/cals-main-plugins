...
function wpgmza_pro_menu() {
    ...
    if (isset($_GET['map_id'])) {
       ...
       if (stripslashes($res->map_height_type) == "%") { $wpgmza_map_height_type_percentage = "SELECTED"; } else { $wpgmza_map_height_type_px = "SELECTED"; }
        ...
        if (isset($other_settings_data['list_markers_by'])) { $list_markers_by_checked[$other_settings_data['list_markers_by']] = "CHECKED"; $list_markers_by_class[$other_settings_data['list_markers_by']] = "wpgmza_mlist_selection_activate"; } else { $list_markers_by = false; }
	    ...
	    if (intval($v_check) < 6300) {
	    	$theme_version_check = "<br /><p><div class='wpgm_notice_message'>Please <a href='update-core.php'>update your WP Google Maps</a> free version to 6.3.00 to make use of this feautre</div></p><br /><br />";
	    } else {
	    	$theme_version_check = "";
	    }
        ...
        <div id=\"wpgmaps_tabs\">
                ...
                <div id=\"tabs-4\">
                    <table class='' id='wpgmaps_advanced_options'>
                        ...
                        <tr>
                            <td width='320'><label for=\"wpgmza_max_zoom\">".__("Maximum Zoom Level","wp-google-maps")."</label></td>
                            <td>
    ...
    if ($short_code_active) {
        ...
        <script type="text/javascript">
            if (typeof window.google === 'object' && typeof window.google.maps === 'object') { } else {
                ...
                document.write(unescape("%3Cscript src='" + gmapsJsHost + "maps.google.com/maps/api/js?<?php echo $api_version_string; ?>sensor=false&language=<?php echo get_locale(); ?>&libraries=weather,places' type='text/javascript'%3E%3C/script%3E"));
            }
        </script>
        ...
        <?php $ajax_nonce_pro = wp_create_nonce("wpgmza_pro_ugm"); ?>
            ...
            wpgmaps_lang_directions = '<?php _e("Directions","wp-google-maps"); ?>';
            wpgmaps_lang_more_info = '<?php echo $wpgmza_settings_infowindow_link_text; ?>';
...
function wpgmaps_head_pro() {
    ...
    if (isset($_POST['wpgmza_savemap'])){
        ...
        if (isset($_POST['wpgmza_iw_type'])) { $other_settings['wpgmza_iw_type'] = $_POST['wpgmza_iw_type']; } else { $other_settings['wpgmza_iw_type'] = ""; }
        ...
        if (isset($_POST['wpgmza_iw_type'])) { $wpgmza_data['wpgmza_iw_type'] = esc_attr($_POST['wpgmza_iw_type']); } else {  $wpgmza_data['wpgmza_iw_type'] = '0'; }
...
function wpgmza_datatables_update() {
    ...
    $wpgmc = new wpgmza();
    $wpgmza_marker_list_output = $wpgmc->list_markers(false,2,$map_id,$category_data,false,false,false,false,false,false);
    echo $wpgmza_marker_list_output;
    die();
...
function wpgmza_datatables_update_sl() {
    ...
    $wpgmza_marker_list_output = $wpgmc->list_markers(false,2,$map_id,false,false,false,$marker_array,false,false,false);
    echo $wpgmza_marker_list_output;
    die();
