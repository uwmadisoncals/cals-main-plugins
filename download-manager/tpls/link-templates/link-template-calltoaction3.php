...
<div class="wpdm-link-tpl well c2a3">
    <div class="media">
        ...
        <div class="media-body">
            <h3 class="media-heading" style="padding-top: 0px;border:0px;margin: 0 0 5px 0;font-size:12pt;"><a style="font-weight: 700" href="[page_url]">[title]</a> <span style="margin-left:30px;font-size:8pt;font-weight:300"><i style="margin: 2px 0 0 5px;" class="far fa-hdd color-green"></i> [file_size] <i style="margin: 2px 0 0 5px;" class="far fa-arrow-alt-circle-down color-purple"></i> [download_count] downloads</span></h3>
            [excerpt_40]
        </div>
