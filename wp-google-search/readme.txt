...
2. Basic Setup, get your search engine ID

3. Enter search engine ID into plugin admin panel

4. Place WP Google Search widget on sidebar

5. Customization example (select layout) 

6. Customization example (look and feel - colors)
