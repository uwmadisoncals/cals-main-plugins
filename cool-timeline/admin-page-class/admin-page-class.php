  ...
  class BF_Admin_Page_Class {
    ...
    public function AddMenuTopPage() {
      $default = array(
        ...
        'menu_title' => '',
        'id'         => 'id',
       'icon_url'   => COOL_TIMELINE_PLUGIN_URL.'/images/timeline-icon-222.png',
        'position'   => null
      );
...
<li>3 New designs (Flat, Elegant,Classic).</li>
...
<li>Visual Composer support/ Addon</li>
    ...
    <img src="' . COOL_TIMELINE_PLUGIN_URL . '/images/7-cool-timeline-demos.png"></a> <a target="_blank" href="http://www.cooltimeline.com/downloads/buy-now-cool-timeline-pro"><img src="' . COOL_TIMELINE_PLUGIN_URL . '/images/6-buy-cool-timeline.png"></a></div>
    </div>';
