...
';
$styles.='.cool-timeline.white-timeline.compact  .timeline-post.ctl-left .timeline-content .content-title,.cool-timeline.white-timeline.compact .timeline-post.ctl-left .icon-color-white{
    background:'.$first_post_color.';
}
...
function clt_pagination($numpages = '', $pagerange = '', $paged='') {
