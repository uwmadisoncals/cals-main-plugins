...
function ctl_right_section($post, $callback){
	...
	$pro_add=__('<div>','apc');
	$pro_add .='<div>
    If you find our plugin and support helpful.<br>Please rate and review us,It helps us grow <br>and improve our services.<br>
    <a target="_blank" href="https://wordpress.org/support/view/plugin-reviews/cool-timeline">Wordpress.org</a><br>
    <a target="_blank" href="https://wordpress.org/support/view/plugin-reviews/cool-timeline"><img src="'.COOL_TIMELINE_PLUGIN_URL.'/images/stars5.png"></a></div>';
...
global $post;
 ...
 function ctl_metabox_handle($post_id) {
    ...
    if ($pID == 0)
        return;
    if (( get_post_type() != '' ) && ( get_post_type() != 'nav_menu_item' ) && ( get_post_type() =='cool_timeline' )&& wp_verify_nonce($_POST['weo-custom-fields-nonce'], 'weo-custom-fields')) {
